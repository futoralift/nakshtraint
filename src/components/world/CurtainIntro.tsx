      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4">
        <div ref={logoRef} className="flex flex-col items-center gap-6 will-change-transform" style={{ opacity: 0 }}>
          <img
            ...
            className="h-40 sm:h-52 md:h-60 w-auto max-w-[85vw] object-contain"
            style={{
              filter: "brightness(0) invert(1) drop-shadow(0 0 80px oklch(0.72 0.075 84 / 0.9))",
            }}
          />
          <div className="flex flex-col items-center gap-2.5">
            <div className="h-px w-36 bg-brass/60" />
            <p
              className="label-caps text-brass"
              style={{ letterSpacing: "0.5em", fontSize: "0.75rem" }}
            >
              Interior Design
            </p>
            <p
              className="label-caps text-background/55"
